...
class KpiCard extends StatelessWidget {
  ...
  IconData _icon() {
    switch (metric.iconName) {
      case 'revenue': return Icons.account_balance_wallet_rounded;
      case 'cars_sold': return Icons.directions_car_rounded;
      case 'loans': return Icons.receipt_long_rounded;
      case 'test_drives': return Icons.speed_rounded;
