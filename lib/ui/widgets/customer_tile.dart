...
class CustomerTile extends StatelessWidget {
  ...
  Color _statusColor() => switch (customer.leadStatus) {
    CustomerLeadStatus.hotLead => AppColors.error,
    CustomerLeadStatus.followUp => AppColors.peach,
    CustomerLeadStatus.converted => AppColors.success,
  };
