...
import 'package:automobile/providers/shift_provider.dart';
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: shift.isActive
              ? [cs.surfaceContainerHigh, cs.surfaceContainerHighest.withValues(alpha: 0.7)]
              : [cs.surfaceContainerHigh.withValues(alpha: 0.7), cs.surfaceContainerHighest.withValues(alpha: 0.4)],
        ),
        border: Border.all(
        ...
        children: [
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: shift.isActive ? AppColors.success : cs.outline,
          ...
          if (shift.isActive) ...[
            ...
            Row(
              ...
              children: [
                Icon(Icons.history_rounded, size: SizeConfig.w(12), color: cs.outline),
                SizedBox(width: SizeConfig.w(4)),
                Text(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: shift.isActive ? AppColors.maroon : cs.primary,
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    shift.isActive ? Icons.stop_circle_rounded : Icons.play_circle_filled_rounded,
                    size: SizeConfig.w(20),
                  ),
                  SizedBox(width: SizeConfig.w(8)),
                  Text(
...
class _EndShiftBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(
        SizeConfig.w(24), SizeConfig.h(12),
        SizeConfig.w(24), SizeConfig.h(32),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.check_circle_rounded, color: cs.primary, size: SizeConfig.w(40)),
          ),
          SizedBox(height: SizeConfig.h(20)),
          Text(
            'End Your Shift?',
          ...
          Container(
            ...
            child: Row(children: [
              _summaryItem(context, Icons.timer_rounded, 'Hours Worked', elapsed, AppColors.info),
              Container(width: 1, height: SizeConfig.h(48), color: cs.outlineVariant.withValues(alpha: 0.4)),
              _summaryItem(context, Icons.directions_car_rounded, 'Sales Made', '$salesCount', AppColors.success),
            ]),
          ),
          SizedBox(height: SizeConfig.h(28)),
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                'Confirm End Shift',
                style: tt.titleSmall?.copyWith(fontWeight: FontWeight.w800, letterSpacing: 0.3),
              ),
            ),
          ),
  ...
  Widget _summaryItem(BuildContext context, IconData icon, String label, String value, Color color) {
    final cs = Theme.of(context).colorScheme;
    final tt = Theme.of(context).textTheme;
    return Expanded(
