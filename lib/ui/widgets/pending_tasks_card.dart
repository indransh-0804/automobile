            ...
            children: [
              Row(children: [
                Container(
                  ...
                  child: Icon(Icons.checklist_rounded, color: cs.primary, size: SizeConfig.w(16)),
                ),
...
class _TaskItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () => ref.read(pendingTasksProvider.notifier).toggleTask(task.id),
        borderRadius: BorderRadius.circular(SizeConfig.w(8)),
        child: Container(
          ...
          child: Row(children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(SizeConfig.w(4)),
                border: Border.all(
                  color: task.isCompleted ? AppColors.success : cs.outline.withValues(alpha: 0.5),
                  width: 2,
                ),
              ),
              child: task.isCompleted
                  ? Icon(Icons.check_rounded, size: SizeConfig.w(12), color: cs.surface)
                  : null,
            ),
